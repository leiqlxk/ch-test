...
# 存储所有节点的速度测试结果
SPEED_TEST = True
SPEED_TEST_LIMIT = 2 # 只测试前30个节点的下行速度，每个节点测试5秒
results_speed = []
MAX_CONCURRENT_TESTS = 100
LIMIT = 700 # 最多保留LIMIT个节点
CONFIG_FILE = 'dist/ch.yaml'
...
clash_config_template = {
    ...
    "rules": [
        ...
        "DOMAIN-SUFFIX,investing.com,DIRECT",
...
if __name__ == '__main__':
	...
	"https://slink.ltd/https://raw.githubusercontent.com/vpnmarket/sub/refs/heads/main/hiddify1",
	...
	"https://slink.ltd/https://raw.githubusercontent.com/skka3134/Free-servers/refs/heads/main/README.md",
